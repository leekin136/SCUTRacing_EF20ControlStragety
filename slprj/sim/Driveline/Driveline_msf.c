...
* i_kgi5os0pto = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; const real_T *
i_pzzv5e1zgg = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T * o_B_2_1
= ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_2_2 = ( real_T
* ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_2_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; oakdhkzk5b * localX = ( oakdhkzk5b * )
ssGetContStates ( S ) ; if ( tid == 0 ) { Driveline ( & ( dw -> rtm ) ,
i_kgi5os0pto , i_pzzv5e1zgg , o_B_2_1 , o_B_2_2 , o_B_2_3 , & ( dw -> rtb ) ,
& ( dw -> rtdw ) , localX , & ( dw -> rtzce ) ) ; cyzpp4e52p ( & ( dw -> rtm
...
; slmrInitializeIOPortDataVectors ( S , 5 , 3 ) ; if ( ! ssSetNumInputPorts (
S , 5 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 1 ) )
...
( S , 4 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 3 ) ) return ; if ( !
...
ssGetInputPortSignal ( S , 0 ) ; const real_T * i_pzzv5e1zgg = ( real_T * )
ssGetInputPortSignal ( S , 3 ) ; real_T * o_B_2_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_2_2 = ( real_T * )
ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_2_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; oakdhkzk5b * localX = ( oakdhkzk5b * )
ssGetContStates ( S ) ; if ( tid != CONSTANT_TID && tid !=
PARAMETER_TUNING_TID ) { Driveline ( & ( dw -> rtm ) , i_kgi5os0pto ,
i_pzzv5e1zgg , o_B_2_1 , o_B_2_2 , o_B_2_3 , & ( dw -> rtb ) , & ( dw -> rtdw
) , localX , & ( dw -> rtzce ) ) ; } }
#define MDL_UPDATE
...
n5qm5cab0up * ) ssGetDWork ( S , 0 ) ; const real_T * i_i0f5w0cuij = ( real_T
* ) ssGetInputPortSignal ( S , 1 ) ; const real_T * i_bcimbstitf = ( real_T *
) ssGetInputPortSignal ( S , 2 ) ; const real_T * i_hdojej45do = ( real_T * )
ssGetInputPortSignal ( S , 4 ) ; bjbjifrsrv * localXdot = ( bjbjifrsrv * )
ssGetdX ( S ) ; bpgqz3xzpl ( i_i0f5w0cuij , i_bcimbstitf , i_hdojej45do , & (
dw -> rtb ) , localXdot ) ; } static void mdlTerminate ( SimStruct * S ) {
n5qm5cab0up * dw = ( n5qm5cab0up * ) ssGetDWork ( S , 0 ) ; btsnzboicn ( & (
dw -> rtm ) ) ; return ; }
