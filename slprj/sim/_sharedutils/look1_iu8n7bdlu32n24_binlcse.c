...
#include "look1_iu8n7bdlu32n24_binlcse.h"

uint8_T look1_iu8n7bdlu32n24_binlcse(uint8_T u0, const real_T bp0[], const
  uint8_T table[], uint32_T maxIndex)
{
  ...
  if (yR_0d0 >= table[iLeft]) {
    y = (uint8_T)((uint32_T)(uint8_T)(((uint8_T)((uint32_T)yR_0d0 - table[iLeft])
      * frac) >> 24) + table[iLeft]);
  } else {
